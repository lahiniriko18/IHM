...
from ..serializer.serializerModele import ModeleEdtSerializer
...
class CreerExcel:
    def __init__(self, nbCase, niveau, parcours, titre):
        self.nbCase= nbCase
        self.niveau= niveau
    ...
    def modele1(self):
        ...
        with pd.ExcelWriter(buffer, engine='openpyxl') as writer:
            ...
            titres = ["",f"Emploi du temps du {self.titre}",f"{self.niveau} {self.parcours}"]
            ...
            ligne3= list(ws.iter_rows(min_row=3, max_row=3,
                                   min_col=1, max_col=ws.max_column))[0]
            ligne7= list(ws.iter_rows(min_row=7, max_row=7,
                                   min_col=1, max_col=ws.max_column))[0]
...
class ModeleExcelView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            fichier=CreerExcel(donnee['nbCase'],donnee['niveau'],donnee['parcours'], donnee['titre'])
            if donnee['typeFichier'] == 1:
                return fichier.modele1()
            else:
                return fichier.modele2()
