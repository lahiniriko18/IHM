    ...
    <>
      ...
      >
        <div className="flex flex-row gap-3 mb-5">
          ...
          <button className=" hover:scale-105 text-gray-500" onClick={versInfo}>
            Général
          </button>
          <button
          ...
          <div className="flex flex-col items-start gap-3 w-[50%]">
            ...
            <div className="flex flex-row gap-3 items-center">
              ...
              <img
                src="/Icons/info.png"
                alt=""
                className="w-6 hover:scale-105 transition-all duration-100 cursor-pointer"
              />
            </div>
            ...
            <div className="flex flex-col w-full gap-5">
              ...
              <div className="w-[50%] flex justify-center items-start flex-col gap-2">
                ...
                <input
                  type="text"
                  className="border leading-6 rounded p-2 w-96"
                  placeholder="ex:#ff10D5"
                />
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col p-2">
              ...
              <div>
                ...
                <input
                  ...
                  name="model"
                  id=""
                  className="ms-3 cursor-pointer p-10"
                />
              </div>
            </div>
